...
function Get-RemediationCommands {
    ...
    if ($hasPythonFailed) {
        ...
        Write-Host ".\.codex\skills\.venv\Scripts\Activate.ps1"
...
function Write-ErrorSummary {
    ...
    $summary = @{
        ...
        remediation = @{
            ...
            pip_retry = ".\.codex\skills\.venv\Scripts\Activate.ps1; pip install <package>"
        }
    }
...
function Show-Usage {
    ...
    Write-Host "  .codex\skills\INSTALLATION.md"
    Write-Host ""
}
